...
export default function Process({ setIsModalOpen, setContent, setModalCategory, setFullScreenModalImages, setFullScreenModalIndex, setFullScreenModalImagesText }) {
  ...
  const overlayAnimation = images.map(() => useAnimationControls());
  const imgBlurAnimation = images.map(() => useAnimationControls());
  const textAnimation = images.map(() => useAnimationControls());
